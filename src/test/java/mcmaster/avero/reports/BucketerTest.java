...
public class BucketerTest {
  ...
  public void hourBucket() {
    Bucketer<Integer> bucketer = new Bucketer<>(BucketerType.HOUR);
    ...
    assertThat(bucket1.start).isEqualTo(expectedStart1);
    assertThat(bucket1.end).isEqualTo(new DateTime(2018, 12, 19, 13, 0));
    assertThat(bucket1.values).containsExactly(1, 2);
    DateTime expectedStart2 = new DateTime(2018, 12, 19, 15, 0);
    Bucketer.Bucket<Integer> bucket2 = buckets.get(expectedStart2);
    assertThat(bucket2.start).isEqualTo(expectedStart2);
    assertThat(bucket2.end).isEqualTo(new DateTime(2018, 12, 19, 16, 0));
    assertThat(bucket2.values).containsExactly(3);
  }

  @Test
  public void dayBucket() {
    Bucketer<Integer> bucketer = new Bucketer<>(BucketerType.DAY);
    DateTime date1 = new DateTime(2018, 12, 19, 12, 2);
    ...
    Bucketer.Bucket<Integer> bucket1 = buckets.get(expectedStart1);
    assertThat(bucket1.start).isEqualTo(expectedStart1);
    assertThat(bucket1.end).isEqualTo(new DateTime(2018, 12, 20, 0, 0));
    assertThat(bucket1.values).containsExactly(1, 2);
    DateTime expectedStart2 = new DateTime(2018, 12, 21, 0, 0);
    Bucketer.Bucket<Integer> bucket2 = buckets.get(expectedStart2);
    assertThat(bucket2.start).isEqualTo(expectedStart2);
    assertThat(bucket2.end).isEqualTo(new DateTime(2018, 12, 22, 0, 0));
    assertThat(bucket2.values).containsExactly(3);
  }

  @Test
  public void weekBucket() {
    Bucketer<Integer> bucketer = new Bucketer<>(BucketerType.WEEK);
    DateTime date1 = new DateTime(2018, 12, 19, 12, 2);
    ...
    Bucketer.Bucket<Integer> bucket1 = buckets.get(expectedStart1);
    assertThat(bucket1.start).isEqualTo(expectedStart1);
    assertThat(bucket1.end).isEqualTo(new DateTime(2018, 12, 24, 0, 0));
    assertThat(bucket1.values).containsExactly(1, 2);
    DateTime expectedStart2 = new DateTime(2018, 12, 24, 0, 0);
    Bucketer.Bucket<Integer> bucket2 = buckets.get(expectedStart2);
    assertThat(bucket2.start).isEqualTo(expectedStart2);
    assertThat(bucket2.end).isEqualTo(new DateTime(2018, 12, 31, 0, 0));
    assertThat(bucket2.values).containsExactly(3);
  }

  @Test
  public void monthBucket() {
    Bucketer<Integer> bucketer = new Bucketer<>(BucketerType.MONTH);
    DateTime date1 = new DateTime(2018, 12, 19, 12, 2);
    DateTime date2 = new DateTime(2018, 12, 21, 14, 59);
    ...
    Bucketer.Bucket<Integer> bucket1 = buckets.get(expectedStart1);
    assertThat(bucket1.start).isEqualTo(expectedStart1);
    assertThat(bucket1.end).isEqualTo(new DateTime(2019, 1, 1, 0, 0));
    assertThat(bucket1.values).containsExactly(1, 2);
    DateTime expectedStart2 = new DateTime(2019, 1, 1, 0, 0);
    Bucketer.Bucket<Integer> bucket2 = buckets.get(expectedStart2);
    assertThat(bucket2.start).isEqualTo(expectedStart2);
    assertThat(bucket2.end).isEqualTo(new DateTime(2019, 2, 1, 0, 0));
    assertThat(bucket2.values).containsExactly(3);
  }
}
